...
! nonhydrostatic component for geopotential
    ...
    real(fp), dimension(ims:ime,jms:jme) :: pfu_tl,pfd_tl,phm_tl
...
! control parameter for theta computation/displacemnt
    ...
    REAL(fp), DIMENSION(ims:ime, jms:jme) :: sum1_tl, sum2_tl, sum3_tl
    REAL(fp), DIMENSION(ims:ime, jms:jme, 2) :: work2d
    REAL(fp), DIMENSION(ims:ime, jms:jme, 2) :: work2d_tl
...
!liq phas poor es
          arg1_tl = (const_17*t1_tl*(t1+243.5)-const_17*t1*t1_tl)/(t1+243.5)**&
             2
          arg1 = const_17*t1/(t1+243.5)
